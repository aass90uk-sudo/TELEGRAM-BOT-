...
PROMPTS = {
    ...
    "jihad":
        "اكتب منشوراً إسلامياً دعوياً مندون مقدمات، ومؤثراً جداً بالفصحى. "
        "يركز على: مواعظ إيمانية، الزوجة الموحدة الصالحة، عقيدة الولاء والبراء، "
        "والدعاء للمجاهدين في كل ثغور المسلمين."
}
